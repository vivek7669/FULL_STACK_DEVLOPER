...
const qminsquantity = () => {
    let qm = document.querySelector('#form1').value;
    qm.value = qm - 1;
}
...
const uimaker = (allproducts) => {
    ...
    allproducts.map((elm,ind)=>{
        ...
        qmbtn.append(qmins);
        qmbtn.addEventListener('click',qminsquantity);
        let inp1 = document.createElement('input');
        inp1.classList.add('form-control','form-control-sm');
        inp1.setAttribute('id','form1');
        ...
        qpbtn.append(qplus);
        qpbtn.addEventListener('click',qplusquantity);
